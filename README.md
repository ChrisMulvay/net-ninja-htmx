# README
Repository created to follow the Net Ninja ["HTMX for Beginners"](https://netninja.dev/courses/?query=htmx).  Click on the videos below to follow along.  This was a very simple tutorial to follow offering a fundamental introduction to HTMX with easy to follow instructions.
